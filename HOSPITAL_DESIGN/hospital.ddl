...
CREATE TABLE diagnoza (
    ...
    karta_pobytu_id_karty   INTEGER NOT NULL
);
...
ALTER TABLE diagnoza ADD CONSTRAINT diagnoza__un UNIQUE ( lekarz_id_lekarza,
                                                          karta_pobytu_id_karty );

CREATE TABLE karta_pobytu (
    id_karty            INTEGER NOT NULL,
    data_przyjecia      DATE NOT NULL,
    godzina_przyjecia   DATE NOT NULL,
    data_wypisu         DATE,
    sala_nr_sali        INTEGER NOT NULL,
    pacjent_pesel       VARCHAR2(11) NOT NULL
);
...
ALTER TABLE kartypobytu_lekarze ADD CONSTRAINT kartypobytu_lekarze_pk PRIMARY KEY ( karta_pobytu_id_karty,
                                                                                    lekarz_id_lekarza );
...
CREATE TABLE lekarze_specjalizacjelekarskie (
    specj_nazwa_specjalizacji   VARCHAR2(50) NOT NULL,
    lekarz_id_lekarza           INTEGER NOT NULL
);
...
ALTER TABLE lekarze_specjalizacjelekarskie ADD CONSTRAINT lek_specj_pk PRIMARY KEY ( specj_nazwa_specjalizacji,
                                                                                     lekarz_id_lekarza );
...
ALTER TABLE operacja ADD CONSTRAINT operacja__un UNIQUE ( lekarz_id_lekarza,
                                                          karta_pobytu_id_karty );
...
CREATE TABLE pielegniarki_sale (
    pielegniarka_id_pielegniarki   INTEGER NOT NULL,
    sala_nr_sali                   INTEGER NOT NULL
);
...
ALTER TABLE pielegniarki_sale ADD CONSTRAINT pielegniarki_sale_pk PRIMARY KEY ( pielegniarka_id_pielegniarki,
                                                                                sala_nr_sali );
...
ALTER TABLE recepta ADD CONSTRAINT recepta__un UNIQUE ( lekarz_id_lekarza,
                                                        karta_pobytu_id_karty );

CREATE TABLE recepty_leki (
    recepta_id_recepty   INTEGER NOT NULL,
    lek_nazwa_leku       VARCHAR2(20) NOT NULL
);

COMMENT ON TABLE recepty_leki IS
    'Tabela zawierajaca informacje o receptach i lekach';

ALTER TABLE recepty_leki ADD CONSTRAINT recepty_leki_pk PRIMARY KEY ( recepta_id_recepty,
                                                                      lek_nazwa_leku );
...
ALTER TABLE diagnoza
    ADD CONSTRAINT diagnoza_karta_pobytu_fk FOREIGN KEY ( karta_pobytu_id_karty )
        REFERENCES karta_pobytu ( id_karty );

ALTER TABLE diagnoza
    ADD CONSTRAINT diagnoza_lekarz_fk FOREIGN KEY ( lekarz_id_lekarza )
        REFERENCES lekarz ( id_lekarza );

ALTER TABLE karta_pobytu
    ADD CONSTRAINT karta_pob_pacj_fk FOREIGN KEY ( pacjent_pesel )
        REFERENCES pacjent ( pesel );

ALTER TABLE karta_pobytu
    ADD CONSTRAINT karta_pobytu_sala_fk FOREIGN KEY ( sala_nr_sali )
        REFERENCES sala ( nr_sali );

ALTER TABLE kartypobytu_lekarze
    ADD CONSTRAINT karty_lek_karta_pob_fk FOREIGN KEY ( karta_pobytu_id_karty )
        REFERENCES karta_pobytu ( id_karty );

ALTER TABLE kartypobytu_lekarze
    ADD CONSTRAINT kartypobytu_lekarze_lekarz_fk FOREIGN KEY ( lekarz_id_lekarza )
        REFERENCES lekarz ( id_lekarza );

ALTER TABLE lekarze_specjalizacjelekarskie
    ADD CONSTRAINT lek_specj_lekarz_fk FOREIGN KEY ( lekarz_id_lekarza )
        REFERENCES lekarz ( id_lekarza );

ALTER TABLE lekarze_specjalizacjelekarskie
    ADD CONSTRAINT lek_specj_specj_fk FOREIGN KEY ( specj_nazwa_specjalizacji )
        REFERENCES specjalizacje ( nazwa_specjalizacji );

ALTER TABLE operacja
    ADD CONSTRAINT operacja_karta_pobytu_fk FOREIGN KEY ( karta_pobytu_id_karty )
        REFERENCES karta_pobytu ( id_karty );

ALTER TABLE operacja
    ADD CONSTRAINT operacja_lekarz_fk FOREIGN KEY ( lekarz_id_lekarza )
        REFERENCES lekarz ( id_lekarza );

ALTER TABLE pielegniarki_sale
    ADD CONSTRAINT piel_sale_piel_fk FOREIGN KEY ( pielegniarka_id_pielegniarki )
        REFERENCES pielegniarka ( id_pielegniarki );

ALTER TABLE pielegniarki_sale
    ADD CONSTRAINT pielegniarki_sale_sala_fk FOREIGN KEY ( sala_nr_sali )
        REFERENCES sala ( nr_sali );

ALTER TABLE recepta
    ADD CONSTRAINT recepta_karta_pobytu_fk FOREIGN KEY ( karta_pobytu_id_karty )
        REFERENCES karta_pobytu ( id_karty );

ALTER TABLE recepta
    ADD CONSTRAINT recepta_lekarz_fk FOREIGN KEY ( lekarz_id_lekarza )
        REFERENCES lekarz ( id_lekarza );

ALTER TABLE recepty_leki
    ADD CONSTRAINT recepty_leki_lek_fk FOREIGN KEY ( lek_nazwa_leku )
        REFERENCES lek ( nazwa_leku );

ALTER TABLE recepty_leki
    ADD CONSTRAINT recepty_leki_recepta_fk FOREIGN KEY ( recepta_id_recepty )
